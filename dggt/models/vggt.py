...
class VGGT(nn.Module, PyTorchModelHubMixin):
    def __init__(self, img_size=518, patch_size=14, embed_dim=1024, semantic_num = 10, useDynamicHead = False, useCameraHead = False):
        super().__init__()
    ...
    def forward(
        ...
        with torch.cuda.amp.autocast(enabled=False):
            ...
            if self.dynamic_head is not None:
                dynamic_conf, _ = self.dynamic_head(dino_token_list, images, patch_start_idx)
